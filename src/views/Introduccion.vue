      ...
      .col-lg-8
        ...
        .bg-color-2.p-4(data-aos="fade-left").mb-4
          .row.align-items-start
            ...
            .col-lg
              p.mb-0 Estas competencias permitirán integrar la accesibilidad como un componente natural del proceso de diseño de experiencia de usuario, garantizando que las soluciones desarrolladas sean utilizables por el mayor espectro posible de usuarios independientemente de sus capacidades físicas, cognitivas o tecnológicas.
      .col-lg-4
        figure
          img(src="@/assets/curso/intro/3.png", data-aos="zoom-in")

    // Bloque 3/5: img-bloque
